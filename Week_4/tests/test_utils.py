...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [
                Product(
                    product_id=1, product_name="Test Product 1", price=10.0, quantity=5
                ),
                Product(
                    product_id=2, product_name="Test Product 2", price=15.0, quantity=15
                ),
            ],
            10,
            ["Test Product 1"],
        ...
        (
            [
                Product(
                    product_id=3, product_name="Test Product A", price=20.0, quantity=3
                ),
                Product(
                    product_id=4, product_name="Test Product B", price=25.0, quantity=2
                ),
            ],
            5,
        ...
        (
            [
                Product(
                    product_id=5, product_name="Test Product X", price=30.0, quantity=20
                ),
                Product(
                    product_id=6, product_name="Test Product Y", price=35.0, quantity=25
                ),
            ],
            10,
            [],
...
def test_write_low_stock_report_parametrized(
    products, threshold, expected_in_output, expected_not_in_output
):
    """
